...
D(e_1.e_2) = D(e_1) & \text{Si } e_1 \text{ n'accepte pas le mot vide}\\
D(e_1.e_2) = D(e_1) \cup D(e_2) & \text{sinon}  \\
D(e^*) = D(e)
\end{cases}
\]

De même, on a besoin de savoir quelles lettres peuvent finir les mots du langage dénoté par une expression : 
...
F(e_1.e_2) = F(e_2) & \text{Si } e_2 \text{ n'accepte pas le mot vide}\\
...
P(e_1.e_2) = P(e_1) \cup P(e_2) \cup F(e_1).P(e_2) \\
P(e^*) = P(e) \cup F(e).D(e) 
\end{cases}
\]
