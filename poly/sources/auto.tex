...
Il n'existe pas d'automate fini reconnaissant le langage $L = \{a^nb^n~|~n \in \mathcal{N}\}$
...
%On dit qu'un ensemble $E$ est clos sous une opération binaire $\cric$ si, pour tous éléments $x$ et $y$ de $E$, $x \cric y$ appartient également à $E$. Dit autrement, $E$ est clos sous une opération $\cric$ ssi. l'application de $\cric$ à ses éléments ne fait pas sortir de l'ensemble. On va regarder si les langages définissables par 
