...
On dit qu'un ensemble $E$ est clos sous une opération binaire $\circ$ si, pour tous éléments $x$ et $y$ de $E$, $x \circ y$ appartient également à $E$. Dit autrement, $E$ est clos sous une opération $\circ$ ssi. l'application de $\circ$ à ses éléments ne fait pas sortir de l'ensemble. On va regarder ici si les langages définissables par automates, ou \textbf{langages rationnels}, sont clos sous les opérations sur les langages.
...
Pas besoin de faire attention pour les états finaux : si $A_2$ accepte le mot vide, au moins un de ses états initiaux est terminal, ce qui veut dire que les transitions qu'on ajoute permettront d'accepter un mot de $L_1$.
\end{proof}
